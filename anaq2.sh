...
./movieq2.sh "$file" "rho --vmin=0.0 --vmax=1.0 --colormap=jet"
./movieq2.sh "$file" "rho --vmin=0.0 --vmax=1.0 --colormap=jet -r 10" "ii"
./movieq2.sh "$file" "rho --vmax=1.0 --logc --colormap=jet" "out_log"
./movieq2.sh "$file" "rho --vmax=1.0 --logc --colormap=jet -r 10" "ii_log"
