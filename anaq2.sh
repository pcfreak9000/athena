...
./spyjob2.sh vis/python/timeaverage.py "$file" 1 3:00:00 '$WORKDIR/simout/master_project.prim $WORKDIR/tavg.athdf' "$minf $maxf 1 -q rho -q u0 -q u1 -q u2 -q u3"
./spyjob2.sh vis/python/spaceaverage.py "$file" 64 00:20:00 '$WORKDIR/simout/master_project.prim $WORKDIR/savg.csv' "$minf $maxf 1 --lvl=2 --max=20 -q q1 -q q2 -q q3"
