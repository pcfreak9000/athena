...
./movieq2.sh "$file" "q1 -a --vmin=0.0 --vmax=12.0 --colormap=seismic --abs" "q1"
./movieq2.sh "$file" "q2 -a --vmin=0.0 --vmax=12.0 --colormap=seismic --abs" "q2"
#./mov3eq2.sh "$file" "q3 --vmin=0.0 --vmax=24.0 --abs" "q3"
./movieq2.sh "$file" "rho -a --vmin=0.0 --vmax=1.0 --colormap=jet"
./movieq2.sh "$file" "rho -a --vmin=0.0 --vmax=1.0 --colormap=jet -r 10" "ii"
./movieq2.sh "$file" "rho -a --vmax=1.0 --logc --colormap=jet" "out_log"
./movieq2.sh "$file" "rho -a --vmax=1.0 --logc --colormap=jet -r 10" "ii_log"
